...
set number relativenumber 			" Row numeration
set tabstop=4
...
let g:startify_custom_header =
		\startify#pad(split(system('figlet -f larry3d -w 100 ViKa'), '\n'))
...
set runtimepath^=~/.vim/bundle/checker.vim
...
nnoremap <silent> <space>p       :<C-u>CocFzfListResume<CR> Show all diagnostics.
